...
public class MainController {
    ...
    public boolean updateDBMcReleases(DBMcReleases dbmcr) {
        try {
            dbMcReleasesJpaController.edit(dbmcr);
            LOGGER.log(Level.INFO, dbmcr.getComponentName() + " set as lessRecommanded [" + dbmcr.isLessRecommended() + "]");
            return true;
        } catch (Exception ex) {
            Logger.getLogger(MainController.class.getName()).log(Level.SEVERE, null, ex);
            return false;
